...
When you're ready, go to [HouseofStake.org](https://houseofstake.org/proposals), select **Create Proposal** in the top-right corner, and follow the prompts.

House of Stake supports two types of proposals:

1. **[Classic Proposal](#1-classic-proposal)** — Estimated timeline: **36–42 days**
2. **[Fast Track Proposal](#2-fast-track-proposal)** — Estimated timeline: **14–21 days**. A **100 NEAR bond** is required when submitting a Fast Track Proposal. The bond helps ensure that submitters are committed to and accountable for the outcome of their proposal.
