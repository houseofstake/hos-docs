...
<br/>2.2.4 House of Stake participants are by definition all veNEAR token holders and the scope of this Code of Conduct applies to all members and partners, without exception.
<br/>2.2.5 House of Stake decisions don’t have competence to rule outside of House of Stake.
...
<br/>2.3.6 Working group members: Appointed or selected individuals tasked with providing various professional services to the community.
<br/>2.3.7 Appeals: Mechanism to report and address a violation of this code of conduct.
...
<br/>3.2.6 Spamming, shilling, brigading, disinformation, or sabotage. Including knowingly false or misleading information intended to influence governance outcomes or produce harm to the House of Stake and its members.

### 3.3 Good Practice Example

3.3.1 A contributor critiques a proposal respectfully and offers alternatives with evidence.
<br/>3.3.2 A contributor is associated by an organization and properly discloses affiliation to understand its influence.
<br/>3.3.3 A contributor raises consideration and signals a behavior that can be contrary to the Code of Conduct, following the reporting mechanisms and providing substantial evidence for analysis.
...
<br/>3.4.2 A contributor buys votes or hides affiliation and influence in relation to submitted proposals.
<br/>3.4.3 A contributor creates noise in public platforms about behavior subjectively evaluated, not facilitating proof or evidence, nor reporting it to proper instances.
...
<br/>4.2.2 Accepting undisclosed compensation or benefits in relation to governance actions.
...
<br/>5.1.2 Provide feedback that is constructive, specific, balanced, and respectful. Constructive feedback is defined as “well communicated, action-oriented, and evidence-based.”
...
<br/>5.1.8 Encourage open participation in feedback, creation and execution processes.
...
<br/>5.2.3 Undue or hostile pressure to conform to arbitrary work rhythms. Constructive encouragement is acceptable. Accountability and transparency are mandatory, and should be practiced without personal attacks.
<br/>5.2.4 Comparisons designed to discredit colleagues based on pace.
<br/>5.2.5 Generalized criticism without constructive intent.
<br/>5.2.6 Any pressure, speculation, or unconstructive criticism that harms collaboration.
<br/>5.2.7 Avoid toxic or hostile criticism disguised as urgency.
<br/>5.2.8 intentionally excluding others from participating, obliterating, not attributing or taking over others work.
...
<br/>6.1.2 Moderators will also pro-actively monitor for violations and process those on behalf of the community.
<br/>6.1.3 AI moderation tools are considered key in achieving a neutral, objective, and human-enhanced environment.
<br/>6.1.4 Member’s feedback is objectively processed without ad hominem criteria, meaning feedback is taken by what is being communicated, and not by who is communicating it, to protect minority voices from being labeled.
...
<br/>6.2.2 Email: info@houseofstake.org (alternative submission if needed).
<br/>6.2.3 Direct contact with the current Community & Moderation team at events or in community channels or calls. Including Head of Governance (HoG), Councils, Committees, and Panels.
...
<br/>6.3.2 Urgency assessment within 48 Business hours to address immediate risks to safety or governance integrity.
<br/>6.3.3 Confidential handling; reporter identities protected where possible.
<br/>6.3.4 Detect abuse of process (e.g., repeated malicious or false reports) is a violation.

### 6.4 Good Practice Example

6.4.1 A member reports a prohibited behavior with timestamps and supporting evidence.
<br/>6.4.2 A minority flags a violation to the Code of Conduct from a high reputation member, with substantial evidence.

### 6.5 Bad Practice Example

6.5.1 A member files repeated false reports to harass another participant.
<br/>6.5.2 A member complains that they are being signaled or excluded, but do not provide solid evidence.
...
<br/>7.4 Timeliness: target resolution within 14 calendar days; document and communicate extensions.
<br/>7.5 AI oversight: AI-powered tools may assist with triage or pattern detection; humans make final decisions.
<br/>7.6 Evidence standards: use verifiable records (e.g., logs, messages, transactions) and note limitations.
<br/>7.7 Objectivity and Fairness: Once documents are ratified, they become legitimate and auditable standards.
<br/>7.8 Hermeneutics: written content could be understood or interpreted differently, and clarification or appeals are a possibility for checks and balances.

### 7.9 Good Practice Example

7.9.1 Assign moderators from outside the immediate dispute to ensure impartiality.

### 7.10 Bad Practice Example

7.10.1 Allowing a conflicted delegate to oversee a case involving their own committee.

## 8. Enforcement & Remedies

8.1 Principles: proportionality, predictability, and restoration where feasible.
<br/>8.1.2 Restorative approaches and capacity building after violations of the Code of Conduct can be implementes by Negotiation, Mediation, and arbitration, as enforcement mechanisms.
<br/>8.1.3 Education about Appeals process and criteria for severity and escalation of sanctions are to be developed to improve predictability, by future proposals on this matter.
...
<br/>8.3.3 Repair: apology, acknowledgement, or clarification including amendments, removal of content or restorative practices.

### 8.4 Temporary Restriction

8.4.1 Observation: repeated or significant violation
<br/>8.4.2 Consequence: time-bound restriction or suspension from channels or roles. Which can apply even while cases are being analyzed.
...
<br/>8.5.2 Consequence: removal from all governance spaces (on-chain and off-chain) to the greatest extent possible, including mitigating, reducing, or reversing financial damage when possible.
<br/>8.5.3 Repair: not applicable; reserved for irreparable breaches of trust.

### 8.6 Proportionality Factors

8.6.1 Moderators will exercise judgement on the level of remedies based on intent, impact, prior history, cooperation, and community safety.

## 9. Appeals Process

9.1 Appeals Panel: at least 3 independent members, rotating annually; no conflicts of interest.
<br/>9.2 Criteria: temporary restrictions and permanent bans can be appealed based upon new evidence (logs, screenshots, transaction records), a claim of misinterpreted evidence, procedural error or disproportionate sanctions.
...
<br/>9.5 Finality: Panel decisions are binding, subject to community ratification in exceptional cases. Escalation to Screening Committee could be requested.

### 9.6 Good Practice Example

9.6.1 A sanctioned member submits new logs that change the assessment; sanction reduced.
Evidence shared is objective and within scope. (logs, screenshots, transaction records)

### 9.7 Bad Practice Example

9.7.1 Multiple frivolous appeals filed to delay enforcement.
...
<br/>10.5 Applicable jurisdiction for legal purposes is **\_\_\_**.
...
<br/>11.4 Moderation team discloses their affiliations, incentives and responsibilities to reduce conflicts of interest.
<br/>11.5 Oversight to all governance actors should be done by responsible bodies ensuring accountability and checks and balances. This is done working in sync with all HoS institutions and ruling documents.
<br/>11.6 NEAR Foundation is accountable for moderation of its ecosystem’s platforms, including the House of Stake’s.
...
<br/>12.4 A minimum public comment period of 7 days is required prior to version adoption of this document, based on Art. 6.1.1 of the interim constitution.
